...
function UILib:CreateTab(Name)
	...
	function TabMethods:CreateDropdown(Config)
		...
		local Open = false
		local ListHeight = math.max(#Options * 26, 1)
		...
		ListClip.Name = "ListClip"
		ListClip.Size = UDim2.new(1, 0, 0, 0)
		ListClip.Position = UDim2.new(0, 0, 1, 4)
		...
		ApplyCorner(ListFrame, Theme.CornerRadiusSmall)
		ApplyStroke(ListFrame, 1)
		...
		local function UpdateLabel()
			Label.Text = tostring(Config.Text or "Dropdown") .. " : " .. tostring(Selected)
		end
		...
		for Index, Option in ipairs(Options) do
			...
			OptionLabel.Position = UDim2.new(0, 6, 0, 0)
			...
			ApplyTextStyle(OptionLabel)

			OptionButton.MouseEnter:Connect(function()
				TweenService:Create(OptionButton, Theme.TweenInfoFast, {
			...
			OptionButton.MouseButton1Click:Connect(function()
				...
				TweenService:Create(ListClip, Theme.TweenInfo, {
					Size = UDim2.new(1, 0, 0, 0)
				}):Play()

				TweenService:Create(Arrow, Theme.TweenInfo, {
					Rotation = 0
				}):Play()
		...
		Holder.MouseButton1Click:Connect(function()
			...
			TweenService:Create(ListClip, Theme.TweenInfo, {
				Size = UDim2.new(1, 0, 0, Open and ListHeight or 0)
			}):Play()
			...
			TweenService:Create(Holder, Theme.TweenInfoFast, {
				BackgroundColor3 = Open and Color3.fromRGB(18, 18, 18) or Theme.BackgroundLight
			}):Play()
		end)
